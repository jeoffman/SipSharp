...
{
    internal abstract class SipHeaders : IHeaderDictionary
    {
        ...
        public static void ValidateHeaderValueCharacters(string headerCharacters)
        {
            ...
            {
                var invalid = SipCharacters.IndexOfInvalidFieldValueChar(headerCharacters);
                if (invalid >= 0)
                {
        ...
        {
            var invalid = SipCharacters.IndexOfInvalidTokenChar(headerCharacters);
            if (invalid >= 0)
            {
                ThrowInvalidHeaderCharacter(headerCharacters[invalid]);
            }
        ...
        {
            throw new ArgumentOutOfRangeException("ThrowInvalidContentLengthException value={value}");
        ...
        {
            throw new InvalidOperationException("ThrowInvalidHeaderCharacter ch={0x{ch:X4}}");
